...
| [building-llama-cpp.md](building-llama-cpp.md)                       | How the eight coexisting llama.cpp builds are installed, why four are official releases and the rest forks or local compilations, and why none is interchangeable.                                                                                                                          |
